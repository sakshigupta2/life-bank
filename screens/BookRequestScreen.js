      ...
      .then((snapshot)=>{
        snapshot.forEach((doc) => {
          ...
          db.collection('all_notifications').add({
            ...
            "message" : name +" " + lastName + " received the blood " + bookName ,
    ...
    if(this.state.IsBookRequestActive === true){
      return(
        ...
        <View style = {{flex:1,justifyContent:'center'}}>
          ...
          <Text style = {{color: "#9e0000", fontSize: 20, fontWeight: 'bold'}}>I recieved the blood </Text>
          </TouchableOpacity>
        </View>
      )
    }
          ...
          <ScrollView>
            <KeyboardAvoidingView style={styles.keyBoardStyle}>
              ...
              <TouchableOpacity
                ...
                >
                <Text  style={{color:'#ffc0cb', fontWeight: 'bold', fontSize: 20}}>Request Blood</Text>
              </TouchableOpacity>
